          ...
          <Row className="bg-white_A700 items-center justify-between mx-[auto] px-[0] self-stretch w-[100%]">
            ...
            <Row className="3xl:mr-[154px] 3xl:my-[21px] font-circularstd items-center justify-center lg:mr-[100px] lg:my-[14px] mr-[129px] my-[18px] w-[47%] xl:mr-[114px] xl:my-[16px]">
              ...
              <SelectBox
                ...
                placeholder={""}
              ></SelectBox>
              <Button className="2xl:py-[13px] 3xl:ml-[38px] 3xl:px-[27px] 3xl:py-[16px] 3xl:text-fs19 bg-white_A700 border border-blue_A400 border-solid font-medium lg:ml-[24px] lg:px-[17px] lg:py-[10px] lg:text-fs12 ml-[32px] px-[23px] py-[13.375px] text-blue_A400 text-center text-fs16 tracking-ls1 w-[21%] xl:ml-[28px] xl:px-[20px] xl:py-[11px] xl:text-fs14">{`Get a demo`}</Button>
              <Button
                className="common-pointer 3xl:ml-[38px] 3xl:my-[15px] bg-transparent border-bw lg:ml-[24px] lg:my-[10px] ml-[32px] my-[13px] w-[9%] xl:ml-[28px] xl:my-[11px]"
                onClick={signIn}
              >
                {""}
              </Button>
        ...
        >
          <Column className="bg-black_900 items-center justify-center mx-[auto] self-stretch w-[100%]">
            ...
            <Row className="3xl:mb-[73px] 3xl:mt-[68px] font-circularstd items-center justify-evenly lg:mb-[47px] lg:mt-[44px] mb-[61px] mt-[57px] mx-[auto] px-[0] self-stretch w-[100%] xl:mb-[54px] xl:mt-[50px]">
              ...
              <Button className="3xl:text-fs16 bg-transparent border-bw font-normal lg:text-fs10 text-fs14 text-left text-white_A700 w-[9%] xl:text-fs12">{`Follow us on social`}</Button>
            </Row>
          </Column>
        </footer>
      </Column>
